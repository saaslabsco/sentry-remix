...
import { Span, TransactionSource } from '@sentry/types';
import { ServerRoute, ServerRouteManifest } from './vendor/types';
/**
 *
 */
 ...
 */
export declare function getTransactionName(routes: ServerRoute[], url: URL): [
    string,
    TransactionSource
];
/**
